...
xst -ifn xst.scr
move clockDivider_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clockDivider_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clockDivider_exdes.ucf clockDivider_exdes

echo 'Running map'
map -timing -pr b clockDivider_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clockDivider_exdes -w routed.ncd routed.v
cd ..
